...
public class BasicClass3 {
	private static Logger logger=Logger.getLogger(BasicClass3.class);
	/**
...
/*	protected WebElement getElement(long timeOutInSeconds, By by) {
	...
	protected WebElement getElement(long timeOutInSeconds, Locator locator) {
		WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
		WebElement element = wait.until(new ExpectedCondition<WebElement>() {
			@Override
			public WebElement apply(WebDriver arg0) {
	 ...
	 * @return 返回元素列表
	 */
	protected List<WebElement> getElements(long timeOutInSeconds, Locator locator) {
		WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
	 ...
	 * @return 返回元素列表
	 */
	protected List<WebElement> getElements(Locator locator) {

		return getElements(5, locator);
	}
	/**
	 * 访问URL
